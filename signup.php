 ...
 */
 ...
 {
 $query= "INSERT INTO `signup` (`First Name`, `Last Name`, `EmailId`, `Username`, `Password`, `Gender`, `Block`, `RoomNo`) VALUES ('".$_POST['firstname']."','".$_POST['lastname']."','".$_POST['email']."','".$_POST['username']."','".$_POST['password']."','".$_POST['gender']."','".$_POST['block']."','".$_POST['room']."')";
 ...
 <div class ="fullbody">
 <div >
 <a href="webpageusingcss.php"> <img src="logo.png" id="logo"></a>
 </div>
 <h2>Sign-Up Here</h2>
 <form method="POST">
